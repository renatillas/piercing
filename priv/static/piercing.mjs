...
var Navigate = class extends CustomType {
  constructor($0) {
    super();
    this[0] = $0;
  }
        ...
        toList([
          button(
            toList([
              ...
              on_click(new Navigate(new Home()))
            ]),
            toList([text2("INICIO")])
          ),
          button(
            toList([
              ...
              on_click(new Navigate(new Gallery()))
            ]),
          ...
          button(
            toList([
              ...
              on_click(new Navigate(new About()))
            ]),
            toList([text2("ACERCA")])
          ),
          button(
            toList([
              ...
              on_click(new Navigate(new Contact()))
            ]),
